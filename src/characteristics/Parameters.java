...
public class Parameters {
  ...
  //---TEAM-A-PARAMETERS---//
  //-----------------------//
  public static final String teamAName = "MaTeam";
  public static final String teamAMainBotBrainClassName = "algorithms.FightBrain"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final double teamAMainBotRadius = 50, //1 unit = 1mm, body radius
                             ...
                             teamAMainBot2InitHeading = NORTH, //clockwise trigonometric unit, according to screen pixel coordinate reference
                             ...
                             teamAMainBot3InitHeading = NORTH; //clockwise trigonometric unit, according to screen pixel coordinate reference

  public static final String teamASecondaryBotBrainClassName = "algorithms.CampBot"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final String teamBMainBotBrainClassName = "Enemy.Viking"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final double teamBMainBotRadius = 50, //1 unit = 1mm, body radius
                             ...
                             teamBMainBotSpeed = 2, //1 unit = 1mm, distance performed at step movement
  ...
  public static final String teamBSecondaryBotBrainClassName = "algorithms.CampFire"; //class given by name; is supposed to extends robotsimulator.Brain
